...
\begin{lstlisting}
$https://github.com/SujanRada/EE1205/blob/main/Audio_%20Filter/codes/k.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{figure}[H]
    ...
    \caption{Spectrogram of the audio file before Audio Filtering}
    \label{fig:before_filter_plot}
\end{figure}
\begin{figure}[H]
\includegraphics[width=0.8\columnwidth]{figs/After_audiofilter.png}
    \caption{Spectrogram of the audio file after Audio Filtering}
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/2.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/5.4.py   
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{3.81}y(n - 1) + \brak{5.46}y(n - 2) \nonumber \\
	&- \brak{3.47}y(n - 3) + \brak{0.83}y(n - 4) \nonumber \\
	&= \brak{1.47\times 10^{-6}}x(n) + \brak{5.88 \times 10^{-6}}x(n - 1) \nonumber \\
	&+ \brak{8.81 \times 10^{-6}}x(n - 2) + \brak{5.87 \times 10^{-6}}x(n - 3) \nonumber \\
	&+ \brak{1.47 \times 10^{-6}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/SujanRada/EE1205/tree/main/Audio_%20Filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\\
\solution The given butterworth filter is lowpass with order=4 and cutoff-frequency=500Hz.
